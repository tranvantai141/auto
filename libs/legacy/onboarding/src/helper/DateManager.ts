...
export class MyDay implements IDay {
  ...
  public createNewDay(millisecondCount: number, setTodaySelected = false) {
    ...
    const dayName = moment(millisecondCount).format(DateManager.HYPHEN_DATE_FORMAT);
    const yearName = dayName.split("-")[0];
    const isToday = dayName === DateManager.TODAY_TEXT_V3 || dayName === DateManager.TODAY_TEXT_V4;
...
export class DateManager {
  ...
  public static readonly TODAY_TEXT_V3 = moment(this.TODAY).format(this.HYPHEN_DATE_FORMAT);
