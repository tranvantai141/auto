...
const CalendarComponent: React.FC<ICalendarComponentProps> = React.memo(
  (props) => {
    const {
      canNextMonth,
      monthHeaderText,
    ...
    const _renderDateNameOfTheWeek = React.useCallback(() => {
      ...
      for (const dateName of dateNameOfTheWeekArr) {
        output.push(
          <View
            {...HelperManager.setLocator(styles.TEST_ID, `dateName`)}
            key={dateName}
            style={styles.dateWrapper}
          >
            <View style={styles.dateItemWrapper}>
              <Text style={styles.dayNameTextHeader}>
    ...
    const _renderMonthContainer = React.useCallback(() => {
      ...
      return (
        <View
          {...HelperManager.setLocator(styles.TEST_ID, `monthContainer`)}
    ...
    return (
      ...
      >
        ...
        <View
          {...HelperManager.setLocator(styles.TEST_ID, `weekContainer`)}
