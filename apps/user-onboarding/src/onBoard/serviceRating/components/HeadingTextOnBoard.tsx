...
import HeadingText from '../../../common/components/onboarding/HeadingText';

export function HeadingsOnBoarding(
  path?: 'userInfo' | 'serviceRating' | 'additionalInfo' | 'userInfo'| 'userService'
) {
  ...
  return (
    <HeadingText
      ...
      headingSecondary={getSecondaryHeading().trim().length >0? translate(getSecondaryHeading()): ''}
