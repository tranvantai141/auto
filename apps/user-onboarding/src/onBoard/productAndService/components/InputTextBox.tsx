...
type Props = {
  ...
  viewSplit?: StyleProp<ViewStyle>;
  textSplit?: StyleProp<TextStyle>;
...
const InputTextBox = (props: Props) => {
  ...
  return (
    <View>
      ...
      {dropdown ? (
        <View style={[Style.input_dropdown_style, viewStyle]}>
          <Dropdown
            style={[
              disabled ? Style.dropdown_disable : Style.dropdown,
              { width: dropdownWidth || wp(28) },
              styleTextInput,
            ]}
            ...
            //   return (
            //     <>
            //       <Text>{item?.productCode} - {item?.productName}</Text>
            //     </>
            //   );
            // }}
          />
        ...
        <View style={Style.inputView}>
          ...
          {sourcePrefix && (
            <>
              <View style={[Style.split_view, viewSplit]} />
              <View style={Style.prefixView}>
                <Text style={[Style.heading_text, textSplit]}>{sourcePrefix}</Text>
              </View>
            </>
          )}
        </View>
      ...
      {!success && (
        <Text style={{ width: wp(28), color: Color.error_red, fontSize: hp(1.2), marginLeft: 5 }}>
          {error_msg || ''}
        </Text>
      )}
    </View>
