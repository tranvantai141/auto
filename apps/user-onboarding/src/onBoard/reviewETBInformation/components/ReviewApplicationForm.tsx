...
import { FormInfo } from '../typings/ReviewInfoResponse';
...
type Props = {
  handleOnSeeDetailsPress: (formId: 'register_customer_acc' | 'register_digibank_form') => void;
            ...
            return index === 1 && !props?.showCompliance ? null : (
              <View
                ...
                style={{
                  ...
                  borderBottomWidth:
                    item.formId === 'register_customer_acc' ? StyleSheet.hairlineWidth : 0,
                }}
              >
