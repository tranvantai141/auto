  ...
  return (
    <View style={[styles.heading, props?.style]}>
      ...
      >
        ...
        <Text style={props?.color ? styles.backTextWhite: styles.backText}>{props?.title}</Text>
      </TouchableOpacity>
      {props.rightHeading && (
        <View style={styles.rightHeading}>
          <TouchableOpacity
            style={props?.color ? styles.cancelButtonWhite : styles.cancelButton}
            onPress={() => {
              setCancel(true);
              props.onPressCancel;
            }}
          >
            <Text style={props?.color ? styles.cancelTextWhite : styles.cancelText}>{translate('cancel_registration')}</Text>
          </TouchableOpacity>
        </View>
      )}
      <CancelModal
