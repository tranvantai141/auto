  ...
  return (
    <View style={Style.container}>
      ...
      >
        ...
        <RNHoleView
          style={Style?.trans_view}
          holes={[
            frame,
          ]}
        />
        <View style={[Style?.border_view, {
          top: frame.y,
          left: frame.x,
          width: frame.width,
          height: frame.height,
      ...
      <View style={Style.top_space}>
        ...
        <View style={Style.bottom_view}>
          <TouchableOpacity
            ...
            onPress={savePicture}
          >
            {imageUri !== undefined ? <IconTakePhotoDisabled height={hp(8.5)} width={hp(8.5)}/> : <IconTakePhotoActive  height={hp(8.5)} width={hp(8.5)} />}
          </TouchableOpacity>
          <GradientButton
            isLoading={isLoading}
