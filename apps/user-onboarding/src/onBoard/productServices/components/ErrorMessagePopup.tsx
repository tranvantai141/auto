...
type Props = {
  ...
  debitCardExistedPopup?: boolean;
  // isMaxNumberCard?: boolean;
};
  ...
  return (
    ...
    >
      <View style={Styles.modal_view}>
        ...
        {props.debitCardExistedPopup && props.debitCardExistedPopup === true ? (
          <View style={Styles?.exist_button_view}>
            <Text style={Styles.exist_title_text}>
              {translate('existing_debitCard_popup_text')}
            </Text>
          </View>
        ) : (
          <View style={Styles?.button_view}>
        ...
        <View style={Styles?.button_view}>
          <GradientButton
            ...
            buttonStyle={
              props.debitCardExistedPopup && props.debitCardExistedPopup === true
                ? Styles?.button_style3
                : Styles?.button_style2
            }
