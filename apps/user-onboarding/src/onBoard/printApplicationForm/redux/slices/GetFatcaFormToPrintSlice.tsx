...
export const GetFatcaFormToPrintSlice = createSlice({
  name: 'GetFatcaFormToPrintSlice',
  initialState,
  reducers: {
...
} = GetFatcaFormToPrintSlice.actions;

export default GetFatcaFormToPrintSlice.reducer;
